    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 pt-12 pb-16 lg:pb-60">
        <div className="flex flex-col items-center text-center">
          ...
          >
            AI Inventory Intelligence<br />for Retail Stores
          </h1>

          {/* 20-word Description */}
          <p className="text-base lg:text-lg text-white/80 leading-relaxed max-w-3xl mt-3">
            Know what will run out. Know what to reorder. Know how much to buy — powered by real sales data and demand prediction.
          </p>
            ...
            <div className="relative h-[400px] overflow-hidden">
              <div className="bg-white">
                ...
                <div className="p-8 space-y-6">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className="rounded-xl bg-gradient-to-br from-emerald-50 via-emerald-50 to-teal-100 p-5 border border-emerald-200/60 shadow-sm hover:shadow-md transition-all">
                      <div className="flex items-start justify-between mb-2">
                        <div className="text-xs font-bold text-emerald-700 tracking-wide uppercase">Total Products</div>
                        <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
                      </div>
                      <div className="text-3xl font-bold text-slate-900 tracking-tight mb-2">248</div>
                      <div className="flex items-center gap-2 mb-3">
                        <div className="text-xs text-emerald-600 font-bold">↗ +8</div>
                    ...
                    <div className="rounded-xl bg-gradient-to-br from-blue-50 via-indigo-50 to-indigo-100 p-5 border border-indigo-200/60 shadow-sm hover:shadow-md transition-all">
                      <div className="flex items-start justify-between mb-2">
                        <div className="text-xs font-bold text-indigo-700 tracking-wide uppercase">Low Stock</div>
                        <div className="w-1.5 h-1.5 rounded-full bg-indigo-500 animate-pulse" />
                      </div>
                      <div className="text-3xl font-bold text-slate-900 tracking-tight mb-2">18</div>
                      <div className="flex items-center gap-2 mb-3">
                        <div className="text-xs text-indigo-600 font-bold">items</div>
                    ...
                    <div className="rounded-xl bg-gradient-to-br from-purple-50 via-purple-50 to-pink-100 p-5 border border-purple-200/60 shadow-sm hover:shadow-md transition-all">
                      <div className="flex items-start justify-between mb-2">
                        <div className="text-xs font-bold text-purple-700 tracking-wide uppercase">Reorder Needed</div>
                        <div className="w-1.5 h-1.5 rounded-full bg-purple-500 animate-pulse" />
                      </div>
                      <div className="text-3xl font-bold text-slate-900 tracking-tight mb-2">12</div>
                      <div className="flex items-center gap-2 mb-3">
                        <div className="text-xs text-purple-600 font-bold">items</div>
                  ...
                  {/* Products At Risk - Enhanced */}
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-sm font-bold text-slate-900 tracking-tight">Products At Risk</h3>
